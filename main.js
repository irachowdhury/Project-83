...
function my_mousemove(e)
{
   ...
   current_position_of_mouse_x = e.clientX - cnavas.offsetLeft;
...
function my_touchmove(e)
{
    ...
    ctx.lineTo(current_position_of_touch_x, current_positon_of_touch_y);
    ctx.stroke();

    last_position_of_touch_x = current_position_of_touch_x;
    last_position_of_touch_y = current_positon_of_touch_y;
